...
public class ColBean {
	...
	/** 字段类型Oracle映射，例如：VARCHAR2 */
	private String colTypeForOracle;
	...
	public String getColTypeForOracle() {
		return colTypeForOracle;
	}

	public void setColTypeForOracle(String colTypeForOracle) {
		this.colTypeForOracle = colTypeForOracle;
	}
...
//		if("CURRENT_TIMESTAMP".equals(defaultValue)) defaultValue = null;	//Mysql的TIMESTAMP生成的"DEFAULT CURRENT_TIMESTAMP"这个语句无法执行，暂时写空
